...
- [x] 7.5 增加 `--tool-setup skip` 的安全 ZIP 效果 fixture，验证首次暂停、相同输入复用和内容变化新工作区
- [x] 7.6 使用 stub 初始化/工具 runner 完成 reservation/并发/session 集成测试，确保 CI 不下载真实 Python/.NET/外部工具
